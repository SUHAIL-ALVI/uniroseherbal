  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-green-50 via-white to-pink-50 overflow-hidden px-6 py-16">
      ...
      <motion.h1
        ...
        transition={{ duration: 1.2 }}
      >
        Classical medicine in Ayurveda&apos;s 
      </motion.h1>
      ...
      >
        A <span className="text-green-600 font-bold">Classical medicine</span> in Ayurveda refers to the traditional, 
        ...
        preparations, renowned for their efficacy and adherence to foundational
