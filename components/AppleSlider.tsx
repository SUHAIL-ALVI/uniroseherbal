  ...
  return (
    <div className="w-full h-full py-20 bg-gradient-to-t from-white via-pink-200 to-green-200 ...">
      <span className="text-center">
        ...
        >
          Unirose{" herbals"}
          <span className={`${permanent_marker.className} text-green-600`}>
            {" "}
            Products
          </span>{" "}
        </h2>
        ...
        return (
          ...
          >
            ...
            <Image
              ...
              height="500"
              width="500"
              className="md:w-1/2 md:h-1/2 h-full w-full mx-auto rounded-md object-contain"
            />
          </div>
        );
      })}
        ...
        return (
          ...
          >
            ...
            <Image
              ...
              height="500"
              width="500"
              className="md:w-1/2 md:h-1/2 h-full w-full rounded-md mx-auto object-contain"
            />
          </div>
        );
      })}
        ...
        return (
          ...
          >
            ...
            <Image
              ...
              height="500"
              width="500"
              className="md:w-1/2 md:h-1/2 h-full w-full pt-3 rounded-xl mx-auto object-contain"
            />
          </div>
        );
      })}
        ...
        return (
          ...
          >
            ...
            <Image
              ...
              height="500"
              width="500"
              className="md:w-1/2 md:h-1/2 h-full rounded-mdrounded-md pt-3 w-full mx-auto object-contain"
            />
          </div>
        );
      })}
